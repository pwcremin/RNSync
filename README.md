...
Add files/binaries.  Cloudant warns against adding too many or too large of files, or you may have performance degredation, but doesn't quantify what that means.
